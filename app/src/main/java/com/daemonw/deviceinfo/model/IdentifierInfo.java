...
public class IdentifierInfo implements ListInfo {
    ...
    public List<ItemInfo> toList() {
        ...
        info.add(new ItemInfo("MEID 2", meid2));
        info.add(new ItemInfo("IMSI 1", imsi1));
        info.add(new ItemInfo("IMSI 2", imsi2));
        info.add(new ItemInfo("电话号码 1", phoneNumber1));
        info.add(new ItemInfo("电话号码 2", phoneNumber2));
        info.add(new ItemInfo("ICCID 1", iccId1));
        info.add(new ItemInfo("ICCID 2", iccId2));
        return info;
    }
}
